...
import { useVoteContentComment } from '~/hooks/queries/comment.query'
...
function CommentActions() {
  ...
  const { mutate: voteComment, isPending: isVoting } = useVoteContentComment({ slug }, contentType)
