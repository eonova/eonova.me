function $404SVG({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 800 600">
      <defs>
        <clipPath id="a">
...
export default function ({ children }: { children?: React.ReactNode }) {
  return (
    <div className="min-h-[500px]">
      <div className="center inset-0 flex flex-col space-y-6">
