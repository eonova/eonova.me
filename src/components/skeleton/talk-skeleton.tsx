  ...
  return (
    ...
    >
      <div className="flex sm:hidden gap-3 sm:w-[40px]">
        <Skeleton className="size-[32px] sm:size-[40px] ring-2 ring-slate-200 dark:ring-zinc-800 rounded-full" />
      ...
      <Skeleton className="hidden sm:block size-[32px] sm:size-[40px] ring-2 ring-slate-200 dark:ring-zinc-800 rounded-full" />
