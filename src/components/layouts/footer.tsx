...
const Footer: React.FC = () => {
  return (
    <footer className="bg-background/30 relative mx-4 md:mx-auto mb-6 flex max-w-[820px] sm:w-full flex-col rounded-2xl p-8 shadow-sm saturate-100 backdrop-blur-[10px]">
